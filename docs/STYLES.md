...
| Primitive 컴포넌트 | `Card / Chip / IconButton / PageSection / Button / DestinationCard / ButtonGrid / TextField / PasswordField / MediaThumb / RadioGroup / Dialog / TabList+Tab+TabPanel` (`@/components/ui`) |
